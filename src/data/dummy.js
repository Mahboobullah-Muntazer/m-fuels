...
export const links = [
...

  {
    ...
    links: [
      ...
      {
        name: 'Customer Account / پیرودونکو حساب',
        link: 'customerAccountMain',
        icon: <FiEdit />,
      },
    ],
  },
  {
    title: 'Management / منجمنټ ',
    links: [
      {
        name: 'employees / کارکوونکي ',
        link: 'employees',
        icon: <IoMdContacts />,
      },
      {
        name: 'suppliers / عرضه کوونکی',
        link: 'suppliers',
        icon: <RiContactsLine />,
      },
      {
        name: 'customers / پیرودونکي',
        link: 'customers',
        icon: <RiContactsLine />,
      },
      // {
      //   name: 'purchase Management / خرید تنظیم',
      //   link: 'purchaseManagement',
      //   icon: <RiContactsLine />,
      // },
    ],
  },
...
export const employeesData = [
  {
    ...
    employeeNIC: '12321231',
    employeeContactNumber: '0787434322',
    employeeSalary: '15000',
    employeeJoinData: '01/02/2021',
  },
  {
    employeeID: 2,
    employeeName: 'Ali',
...
export const suppliersData = [
  {
    ID: 1,
    organizationName: 'Khan petroleum',
    authorizedPerson: 'Waheed',
    contactNumber: '0787434322',
    address: 'kabul,Afghanistan',
  },
  {
    ID: 2,
    supplierOrganizationName: 'ABC co ltd',
    supplierAuthorizedPerson: 'Subhan',
    supplierContactNumber: '078744334322',
    supplierAddress: 'Herat,Afghanistan',
  },
];
export const purchaseData = [
  {
    ID: 1,
    supplier: 'Khan petroleum',
    fuelType: 'Petrol',
    driverName: 'Ihsanullah khan',
    plateNumber: '872322 kbl',
    quantity: '5',
    measureUnit: 'Tons',
    totalPrice: '120000',
    date: '2024-01-03',
    transferedFromAddress: 'kabul',
  },
  {
    ID: 2,
    supplier: 'ABC co ltd',
    fuelType: 'Gas',
    driverName: 'Safiullah khan',
    plateNumber: '843322 NGR',
    quantity: '100',
    measureUnit: 'Litter',
    totalPrice: '200000',
    date: '2023-12-15',
    transferedFromAddress: 'Herat',
  },
];
...
export const sellsData = [
  {
    ...
    customerName: 'Wahaj',
    sellDate: '2024-01-03',
    customerContact: '07832432234',
    customerAddress: 'jalalabad',
  },
  {
    sellsID: 2,
    fuelType: 'Gas',
    ...
    sellDate: '2023-01-03',
    customerContact: '07832432234',
    customerAddress: 'Kabul',
  },
];

export const expnsesData = [
  {
    expenseId: 1,
    expenseBy: 'Khan ',
    amount: '100',

    reason: 'pay electracity bill ',
  },
  {
    expenseId: 2,
    expenseBy: 'Ali ',
