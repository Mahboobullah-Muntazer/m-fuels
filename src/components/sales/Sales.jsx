...
const Sales = ({handleNewSale,handleUpdateSale}) => {
  ...
  const getAllSales = async function () {
    ...
    try {
      ...
      if (res.data.status !== 'FAILED') {
        console.log("SaleData",res.data.data);
  ...
  const handleButtonClick = () => {
    ...
    handleNewSale(selectedCollection)
  ...
  const handleRowClick = (args) => {
    ...
    handleUpdateSale(args.data,selectedCollection)
