...
const SupplierDetails = ({purchaseData,selectedCollection,handleBackToPurchaseHome}) => {
  ...
  useEffect(() => {
    if (purchaseData) {
      ...
      const { 
        ...
        totalPrice,
        transferedFromAddress,
        purchaseDate } = purchaseData.purchase;
      setFormData({
        _id,
    supplier,
    fuelType,
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${SERVER_PATH}api/actions/deletePurchase`,
        purchaseData,
        config
      );
    ...
    Collection: {selectedCollection?.collectionName}
        ...
        <div className='flex-grow grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div className='mb-4'>
            ...
            {'-----('+purchaseData?.purchase?.supplier+')'}
            </label>
            {loading ? (
          ...
          <div className='mb-4'>
            ...
            <input
              type='date'
              placeholder={purchaseData?.purchase?.purchaseDate}
          ...
          <div className='mb-4'>
            ...
            <input
              ...
              placeholder={purchaseData?.purchase?.driverName}
              className='w-full border dark:border-none dark:bg-gray-700 dark:text-gray-200 rounded-md px-3 py-2 mt-1'
            />
          </div>
          <div className='mb-4'>
            ...
            <input
              ...
              placeholder={purchaseData?.purchase?.plateNumber}
              className='w-full border dark:border-none dark:bg-gray-700 dark:text-gray-200 rounded-md px-3 py-2 mt-1'
            />
          </div>
          ...
          <div className='mb-4'>
            ...
            <input
              ...
              placeholder={purchaseData?.purchase?.quantityInTons}
              className='w-full border dark:border-none dark:bg-gray-700 dark:text-gray-200 rounded-md px-3 py-2 mt-1'
            />
          </div>
          ...
          <div className='mb-4'>
            ...
            <input
              ...
              placeholder={purchaseData?.purchase?.quantityInLiters}
              className='w-full border dark:border-none dark:bg-gray-700 dark:text-gray-200 rounded-md px-3 py-2 mt-1'
            />
          </div>
          ...
          <div className='mb-4'>
            ...
            <input
              ...
              placeholder={purchaseData?.purchase?.totalPrice}
              className='w-full border dark:border-none dark:bg-gray-700 dark:text-gray-200 rounded-md px-3 py-2 mt-1'
            />
          </div>
        ...
        <div className='mb-4 mt-4'>
          ...
          <textarea
            ...
            rows={2}
            style={{ resize: 'none' }}
            placeholder={purchaseData?.purchase?.transferedFromAddress}
            className='w-full border dark:border-none dark:bg-gray-700 dark:text-gray-200 rounded-md px-3 py-2 mt-1'
          />
