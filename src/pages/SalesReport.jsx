...
const SalesReport = () => {
  ...
  const calculateSums = () => {
    ...
    sales.forEach((sale) => {
      totalPriceSum += sale.totalPrice;
      quantityInLitersSum += sale.quantityInLiters;
      quantityInTonsSum += sale.quantityInTons;
    });
...
<div id="salesTable" className=''>
<div className='flex w-full justify-center bg-slate-300 rounded-sm'>  <h2 className='font-bold text-lg mt-5 mb-5'>Sale Report / خرڅلاو ریپورټ</h2></div>
<table className="min-w-full border border-gray-300">
           <thead>
             <tr>
               ...
               <th className="py-2 px-4 border-b">پیرودونکی</th>
               ...
               <th className="py-2 px-4 border-b">خرڅلاو نیټه</th>
               <th className="py-2 px-4 border-b">بیل</th>
           ...
           <tbody>
             {sales.map((sale,i) => (
              ...
              <td className="py-2 px-4 border-b text-center">{sale.customer.customerName}</td>
                 <td className="py-2 px-4 border-b text-center">{sale.totalPrice}</td>
                 <td className="py-2 px-4 border-b text-center">{sale.quantityInLiters}</td>
                 <td className="py-2 px-4 border-b text-center">{sale.quantityInTons}</td>
                 <td className="py-2 px-4 border-b text-center">{sale.driverName}</td>
                 <td className="py-2 px-4 border-b text-center">{sale.fuelType}</td>
                 <td className="py-2 px-4 border-b text-center">{sale.saleDate}</td>
                 <td className="py-2 px-4 border-b text-center">{sale.billNumber}</td>
               </tr>
             ))}
